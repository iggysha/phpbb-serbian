...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_MYSQL_NOT_SUPPORTED'			=> 'MySQL fulltext индекси могу бити коришћени само са MyISAM или InnoDB табелама. MySQL 5.6.8 или новији је неопходан за fulltext индексе на InnoDB табелама.',
	...
	'INDEXING_IN_PROGRESS_EXPLAIN'			=> 'Позадина претраге тренутно индексира све поруке на форуму. Ово може узети од неколико минута до неколико часова у зависности од величине вашег форума.',
	...
	'SEARCH_GUEST_INTERVAL_EXPLAIN'			=> 'Број секунди које гост мора да сачека између претрага. Уколико један гост претражује сви остали морају да чекају док то временско раздобље не прође.',
	...
	'SEARCH_INDEX_DELETE_REDIRECT'			=> array(
		2	=> 'Све поруке до поруке id %2$d су уклоњене из индекса претраге, од којих је %1$d порука било унутар овог корака.<br />',
	),
	'SEARCH_INDEX_DELETE_REDIRECT_RATE'		=> array(
		2	=> 'Тренутна учесталост брисања је приближно %1$.1f порука по секунди.<br />Брисање је у току…',
	),
	...
	'SEARCH_STORE_RESULTS'					=> 'Дужина кеша исхода претраге',
	'SEARCH_STORE_RESULTS_EXPLAIN'			=> 'Кеширани исходи претраге ће истећи после овог времена, у секундама. Подесите на 0 уколико желите да онемогућите кеширање претраге.',
