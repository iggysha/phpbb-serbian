...
$lang = array_merge($lang, array(
	...
	'ACL_U_EMOJI'		=> 'Може користити емотиконе и специјалне карактере у наслову теме',

	'ACL_U_SENDPM'		=> 'Може слати приватне поруке',
	'ACL_U_MASSPM'		=> 'Може слати приватне поруке вишеструким корисницима',
	'ACL_U_MASSPM_GROUP'=> 'Може слати приватне поруке групама',
