...
$lang = array_merge($lang, array(
	...
	'MANAGE'				=> 'Уреди',
	'MENU_TOGGLE'			=> 'Сакриј или прикажи бочни изборник',
...
$lang = array_merge($lang, array(
	...
	'NO_ENTRIES'	=> 'Нема записа за ово временско раздобље.',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'Ово вам даје преглед последњих пет поступака обављених од администратора форума. Пуни умножак записа може бити виђен из одговарајуће ставке изборника или следећи везу испод.',
	'AVATAR_DIR_SIZE'			=> 'Величина фасцикле грбова',

	'BOARD_STARTED'		=> 'Форум почео са радом',
	'BOARD_VERSION'		=> 'Издање форума',
...
$lang = array_merge($lang, array(
	...
	'LOG_TEMPLATE_CACHE_CLEARED'	=> '<strong>Обрисани кеширани облици датотека предложака у комплету предложака <em>%1$s</em></strong><br />» %2$s',
	...
	'LOG_UPDATE_DATABASE'	=> '<strong>Ажурирана База из издања %1$s у издање %2$s</strong>',
	'LOG_UPDATE_PHPBB'		=> '<strong>Ажуриран phpBB из издања %1$s у издање %2$s</strong>',
