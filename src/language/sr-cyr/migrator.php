...
$lang = array_merge($lang, array(
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'Нешто је кренуло лоше током захтева и изузетак је избачен. Промене направљене пре грешке која се појавила су враћене на најбољи могући начин, али бисте ипак требали да проверите форум за могуће грешке:<br><br>%s',
