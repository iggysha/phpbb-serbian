...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Ваш налог је направљен. Међутим, овај форум захтева активацију налога. Активациони кључ је послат на мејл адресу коју сте дали. Молимо вас да проверите ваш мејл за више података а посебно смеће у вашој пошти. Може потрајати неко време док добијете мејл у зависности од вашег мејл провајдера.',
	...
	'ADD'							=> 'Додај',
	'ADD_BCC'						=> 'Додај [BCC]',
	'ADD_FOES'						=> 'Додај нове за занемаривање',
	...
	'ATTACHMENT_LOCKED'				=> 'Ова тема је закључана, па не можете обрисати прилог.',
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> 'Коришћена синтакса је истоветна PHP <a href="https://secure.php.net/manual/function.date.php">date()</a> функцији.',
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'Поље “%2$s” је прекратко, најмање %1$d знак је потребан.',
		2	=> 'Поље “%2$s” је прекратко, најмање %1$d знака је потребно.',
		3	=> 'Поље “%2$s” је прекратко, најмање %1$d знакова је потребно.',
	),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'Поље “%2$s” је предугачко, највише %1$d знак је дозвољен.',
		2	=> 'Поље “%2$s” је предугачко, највише %1$d знака је дозвољено.',
		3	=> 'Поље “%2$s” је предугачко, највише %1$d знакова је дозвољено.',
	),
	...
	'FOE_MESSAGE'				=> 'Порука од занемареног',
	'FOES_EXPLAIN'				=> 'Занемарени су корисници који ће бити занемарени по подразумеваном. Поруке од тих корисника неће бити потпуно видљиве. Приватне поруке од занемарених су још увек допуштене. Молимо знајте да не можете занемаривати уреднике или администраторе.',
	'FOES_UPDATED'				=> 'Ваш списак за занемаривање је успешно ажуриран.',
	'FOLDER_ADDED'				=> 'Фасцикла је успешно додата.',
	'FOLDER_MESSAGE_STATUS'		=> array(
		1	=> '%2$d од %1$s сачувана',
		2	=> '%2$d од %1$s сачуване',
		3	=> '%2$d од %1$s сачувано',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Фасцикла је %3$d%% попуњена (%2$d од %1$s сачувана)',
		2	=> 'Фасцикла је %3$d%% попуњена (%2$d од %1$s сачуване)',
		3	=> 'Фасцикла је %3$d%% попуњена (%2$d од %1$s сачувано)',
	),
	...
	'INVALID_EMOJIS_USERNAME'	=> 'Корисничко име садржи забрањене знакове (Emoji).',
	...
	'MESSAGE_REPORTED_MESSAGE'		=> 'Пријављена порука',
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'Дошло је до грешке приликом премештања порука у нову фасциклу, само је %2$d од %1$s премештена.',
		2	=> 'Дошло је до грешке приликом премештања порука у нову фасциклу, само су %2$d од %1$s премештене.',
		3	=> 'Дошло је до грешке приликом премештања порука у нову фасциклу, само је %2$d од %1$s премештено.',
	),
	...
	'NOTIFICATION_METHOD_BOARD'							=> 'Обавештења',
	...
	'NOT_ADDED_FRIENDS_FOES'		=> 'Не можете додавати кориснике на ваш списак пријатеља када су већ на вашем списку за занемаривање.',
	'NOT_ADDED_FRIENDS_SELF'		=> 'Не можете додати сами себе на списак пријатеља.',
	'NOT_ADDED_FOES_MOD_ADMIN'		=> 'Не можете додавати администраторе и уреднике на ваш списак за занемаривање.',
	'NOT_ADDED_FOES_ANONYMOUS'		=> 'Не можете додати анонимног корисника на ваш списак за занемаривање.',
	'NOT_ADDED_FOES_BOTS'			=> 'Не можете додавати ботове на ваш списак за занемаривање.',
	'NOT_ADDED_FOES_FRIENDS'		=> 'Не можете додавати кориснике на ваш списак за занемаривање када су већ на вашем списку пријатеља.',
	'NOT_ADDED_FOES_SELF'			=> 'Не можете додати сами себе на списак за занемаривање.',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		...
		2	=> 'Имате %d приватне поруке тренутно на чекању због попуњене фасцикле.',
		3	=> 'Имате %d приватних порука тренутно на чекању због попуњене фасцикле.',
	),
	...
	'NO_AUTH_PRINT_MESSAGE'			=> 'Нисте овлашћени да штампате приватне поруке.',
	...
	'EMAIL_NOT_UNIQUE'			=> 'Мејл који сте назначили користи више корисника. Морате одабрати корисничко име такође.',
	'NO_FOES'					=> 'Тренутно немате одређених за занемаривање',
	...
	'NO_RESET_TOKEN'			=> 'Немате токен за ресет лозинке.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Лозинка мора бити дуга барем %1$s карактера, мора садржати велика и мала слова и мора садржати бројеве.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Мора бити барем %1$s карактера дуга.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Лозинка мора бити дуга барем %1$s карактера и мора садржати велика и мала слова.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Лозинка мора бити дуга барем %1$s карактера, мора садржати велика и мала слова, мора садржати бројеве и мора садржати симболе.',
	'PASSWORD'					=> 'Лозинка',
	'PASSWORD_ACTIVATED'		=> 'Ваша нова лозинка је активирана.',
	'PASSWORD_RESET'			=> 'Ваша лозинка је успешно ресетована.',
	'PASSWORD_RESET_LINK_SENT'	=> 'Ако ваш налог постоји, веза за ресетовање лозинке је послата на регистровану адресу електронске поште. Ако не добијете поруку могуће је да вам је забрањен приступ форуму, да ваш налог није активиран, да сте захтевали превише ресета лозинке у врло кратком временском интервалу или да вам није дозвољено да мењате лозинку. Контактирајте администратора ако се било шта од наведеног односи на вас. Такође проверите ваш spam филтер.',
	...
	'OAUTH_REGISTRATION'				=> 'Регистрација коришћењем услуге треће стране',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'Токен за ресет лозинке који сте употребили је неважећи или је истекао.',
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		...
		2	=> '%d приватне поруке су уклоњене због пречистача приватних порука.',
		3	=> '%d приватних порука је уклоњено због пречистача приватних порука.',
	),
	...
	'UCP_ZEBRA'						=> 'Пријатељи &amp; Занемарени',
	'UCP_ZEBRA_FOES'				=> 'Управљање занемаренима',
