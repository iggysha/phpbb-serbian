...
$lang = array_merge($lang, array(
	...
	'ALL_RESULTS'			=> 'Сви исходи',

	'DISPLAY_RESULTS'		=> 'Прикажи исходе као',

	'FOUND_SEARCH_MATCHES'		=> array(
		1	=> 'Пронађен је %d исход',
		2	=> 'Пронађена су %d исхода',
		3	=> 'Пронађено је %d исхода',
	),
	'FOUND_MORE_SEARCH_MATCHES'		=> array(
		1	=> 'Пронађено је више од %d исхода',
		2	=> 'Пронађено је више од %d исхода',
		3	=> 'Пронађено је више од %d исхода',
	),
	...
	'MAX_NUM_SEARCH_KEYWORDS_REFINE'	=> array(
		...
		3	=> 'Изабрали сте превише речи за претрагу. Молимо немојте уносити више од %1$d речи.',
	),
	...
	'NO_SEARCH_TIME'		=> array(
		...
		2	=> 'Жао нам је али тренутно не можете користити претрагу. Молимо вас да пробате поново за %d секунде.',
		3	=> 'Жао нам је али тренутно не можете користити претрагу. Молимо вас да пробате поново за %d секунди.',
	),
	...
	'RESULT_DAYS'			=> 'Ограничи исходе на претходних',
	'RESULT_SORT'			=> 'Поређај исходе по',
	...
	'SEARCH_IN_RESULTS'			=> 'Претражи ове исходе',
	...
	'TOO_FEW_AUTHOR_CHARS'	=> array(
		1	=> 'Морате унети најмање %d знак од имена аутора.',
		2	=> 'Морате унети најмање %d знака од имена аутора.',
		3	=> 'Морате унети најмање %d знакова од имена аутора.',
	),
));
