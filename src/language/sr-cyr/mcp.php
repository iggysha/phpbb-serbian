...
$lang = array_merge($lang, array(
	...
	'PM_REPORTS_TOTAL'			=> array(
		...
		1	=> 'Укупно има <strong>%d</strong> ПП пријава за преглед.',
		2	=> 'Укупно има <strong>%d</strong> ПП пријаве за преглед.',
		3	=> 'Укупно има <strong>%d</strong> ПП пријава за преглед.',
	),
	...
	'REPORTS_TOTAL'				=> array(
		...
		1	=> 'Укупно има <strong>%d</strong> пријава за преглед.',
		2	=> 'Укупно има <strong>%d</strong> пријаве за преглед.',
		3	=> 'Укупно има <strong>%d</strong> пријава за преглед.',
	),
	...
	'UNAPPROVED_POSTS_TOTAL'		=> array(
		...
		2	=> 'Укупно има <strong>%d</strong> поруке које чекају на одобрење.',
		3	=> 'Укупно има <strong>%d</strong> порука које чекају на одобрење.',
	),
	'UNLOCK'						=> 'Откључај',
