...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Сада сте успешно пребацили ваш форум у phpBB 3.2. Сада се можете пријавити и <a href="../">приступити вашем форуму</a>. Молимо проверите да ли су поставке успешно пребачене пре него што омогућите ваш форум брисањем фасцикле install. Имајте у виду да је помоћ за коришћење phpBB доступна преко <a href="https://www.phpbb.com/support/docs/en/3.2/ug/">Документације</a> и <a href="https://www.phpbb.com/community/viewforum.php?f=466">форума подршке</a>.',
