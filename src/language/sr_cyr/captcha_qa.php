...
$lang = array_merge($lang, array(
	...
	'CONFIRM_QUESTION_MISSING'	=> 'Питања за captcha не могу бити извађена. Молимо повежите се са администратором форума.',
	...
	'QUESTIONS'					=> 'Питања',
	'QUESTIONS_EXPLAIN'			=> 'За свако попуњавање образаца где сте омогућили Q&amp;A прикључак, корисници ће бити питани једно од питања назначених овде. За коришћење овог прикључка бар једно питање мора бити постављено у подразумеваном језику. Ова питања би требало да буду лака за вашу циљну групу да одговори али ван домашаја ботова који могу да врше Google™ претраге. Коришћење великог и редовно мењаног комплета питања ће постићи најбоље исходе. Омогућите стриктну поставку уколико ваше питање указује на мешовита велика и мала слова, знакове интерпункције или празан простор.',
