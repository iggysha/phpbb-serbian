...
$lang = array_merge($lang, array(
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Сакриј поље профила од свих корисника осим администратора и уредника, који могу и даље да виде ово поље профила. Уколико је поставка Приказа у корисничкој контролној плочи онемогућена, корисник неће моћи да види нити да промени ово поље профила а поље може бити промењено само од администратора.',
	...
	'STEP_3_EXPLAIN_CREATE'			=> 'Пошто имате више од једног језика инсталирано на форуму, мораћете такође да попуните преостале ставке језика. Уколико то не урадите, онда ће подразумевана поставка језика за властито поље профила бити коришћена, такође можете да попуните преостале језичке ставке касније.',
	'STEP_3_EXPLAIN_EDIT'			=> 'Пошто имате више од једног језика инсталирано на форуму, сада такође можете да промените или додате преостале језичке ставке. Уколико то не урадите, онда ће подразумевана поставка језика за ово властито поље профила бити коришћена.',
