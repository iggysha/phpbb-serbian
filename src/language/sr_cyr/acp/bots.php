...
/**
*
* acp_bots [Serbian (Cyrillic script)]
*
* @package language
* @version $Id$
...
$lang = array_merge($lang, array(
	...
	'NO_BOT'		=> 'Није пронађен ниједан робот са одређеним ID.',
