...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Овде можете управљати свим врстама модула. Молимо знајте да АКП има тро-слојну структуру изборника (Категорија -> Категорија -> Модул) док остали имају дво-слојну структуру изборника (Категорија -> Модул) која мора бити сачувана. Молимо такође да будете пажљиви јер можете закључати сами себе уколико онемогућите или обришете модуле одговорне за управљање самим модулима.',
