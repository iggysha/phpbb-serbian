...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'Овде можете направити резервни умножак свих phpBB података. Добијена архива ће бити похрањена у вашој <samp>store/</samp> фасцикли. У зависности од конфигурације вашег сервера можете бити у могућности да сабијете датотеку у неколико облика.',
	...
	'BACKUP_NOT_SUPPORTED'	=> 'Одабрани резервни умножак није подржан',
