...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'Ове појединости одређују податке коришћене за слање колачића прегледачима ваших корисника. У већини случајева подразумеване вредности за поставке колачића би требале бити довољне. Уколико вам треба да промените било коју урадите то пажљиво, неисправне поставке могу спречити кориснике да се пријаве. Уколико имате проблема са корисницима који остају пријављени на форуму, посетите <b><a href="https://www.phpbb.com/support/go/cookie-settings/">phpBB.com Knowledge Base - Fixing incorrect cookie settings</a></b>.',

	'COOKIE_DOMAIN'				=> 'Домен колачића',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'У највећем броју случајева домен колачића је необавезан. Оставите празно ако нисте сигурни.<br /><br /> У случајевима где имате форум интегрисан са другим програмом или имате вишеструке домене, онда за одређивање домена колачића треба да урадите следеће. Уколико имате нешто као <i>example.com</i> и <i>forums.example.com</i>, или можда <i>forums.example.com</i> и <i>blog.example.com</i>. Уклоните поддомене док не нађете заједнички домен, <i>example.com</i>. Сада додајте тачку испред заједничког домена и треба да унесете .example.com (имајте у виду тачку на  почетку).',
	'COOKIE_NAME'				=> 'Име колачића',
	'COOKIE_NAME_EXPLAIN'		=> 'Ово може бити шта год да желите, у буквалном смислу. Кад год се мењају поставке колачића онда и име колачића треба да буде промењено.',
	'COOKIE_PATH'				=> 'Путања колачића',
	'COOKIE_PATH_EXPLAIN'		=> 'Имајте у виду да је ово увек коса цртица, без обзира која је URL вашег форума.',
