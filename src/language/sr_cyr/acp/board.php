...
$lang = array_merge($lang, array(
	...
	'SYSTEM_TIMEZONE_EXPLAIN'			=> 'Временска зона која се користи за приказ времена корисницима који нису пријављени (гости, роботи). Пријављени корисници подешавају њихову временску зону током регистрације и могу је променити у корисничкој контролној плочи.',
...
$lang = array_merge($lang, array(
	...
	'FLOOD_INTERVAL_EXPLAIN'		=> 'Број секунди колико корисник мора да сачека између слања нових порука. Да бисте омогућили корисницима да занемаре ово измените њихове дозволе.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_GROUP_DEFAULT'		=> 'Поставља групу Ново Регистровани Корисници као задату',
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_PREVIEW_MSG'					=> 'Ваше измене нису сачуване, ово је само преглед.',
...
$lang = array_merge($lang, array(
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'	=> 'После овог броја погрешних пријава корисник треба додатно да реши анти-спамбот задатак.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'Уколико је ово постављено на онемогућено ниједан e-mail неће бити послат са форума уопште. <em>Знајте да поставке активације налога корисника и админа потребују да ова поставка буде омогућена. Уколико тренутно користите “корисник” или “админ” активацију у поставкама активације, онемогућавањем ове поставке неће се тражити никаква активација нових налога.</em>',
