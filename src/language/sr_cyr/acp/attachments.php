...
$lang = array_merge($lang, array(
	...
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Овде можете да додате, бришете, мењате или онемогућите ваше проширене групе. Даље поставке укључују додељивање посебних категорија групама, мењање начина за преузимање и одређивање иконице за додавање која ће бити приказана испред прилога који припада групи.',
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'		=> 'Највећа величина сваке датотеке, са 0 постаје неограничено.',
	...
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Промени задато понашање када су безбедна преузимања омогућена од списка Дозвола/Забрана у оно од <strong>бела листа</strong> (Дозвола) или <strong>црна листа</strong> (Забрана).',
	...
	'UPLOAD_DIR_EXPLAIN'			=> 'Путања за складиштење прилога. Молимо знајте да уколико промените ову фасциклу а имате већ додате прилоге треба да ручно копирате датотеке на њихово ново место.',
