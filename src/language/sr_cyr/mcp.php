...
$lang = array_merge($lang, array(
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'Користећи образац испод можете спојити изабране поруке у другу тему. Овим порукама неће бити измењен редослед и појавиће се као да су их корисници послали у нову тему.<br />Молимо вас да унесете id одредишне теме или кликните на “Изабери тему” да је потражите.',
