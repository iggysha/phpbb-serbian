...
$help = array(
	...
	array(
		...
		1 => 'Уколико сте сигурни да сте временску зону и Летње Рачунање времена/DST подесили исправно а време је и даље неисправно, онда је време сачувано на сату сервера неисправно. Молимо вас да обавестите администратора да отклони сметње.'
	),
	array(
	...
	array(
		0 => 'Шта је ББКод?',
		1 => 'ББКод је посебна примена HTML, која нуди велику контролу у обликовању одређених објеката у поруци. Коришћење ББКода је омогућено од администратора, али такође може да буде и онемогућено по порукама у обрасцу за писање. ББКод је сам по себи сличан у стилу са HTML, али су тагови затворени угластим заградама [ и ] пре него &lt; and &gt;. За више података о ББКоду погледајте водич којем можете да приступите са странице за писање.'
	),
	array(
