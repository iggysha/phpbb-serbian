...
$lang = array_merge($lang, array(
	...
	'DB_UPDATE_NOT_SUPPORTED'	=> 'Жао нам је, али ова скрипта не подржава ажурирање phpBB издања старијих од “%1$s”. Издање које тренутно имате инсталирано је “%2$s”. Молимо ажурирајте на претходно издање пре покретања ове скрипте. Помоћ са овим је доступна на Форуму Подршке на phpBB.com.',
	'DB_USERNAME'				=> 'Корисничко име базе',
	'DB_TEST'					=> 'Испробај везу',
	'DEFAULT_LANG'				=> 'Подразумевани језик форума',
	'DEFAULT_PREFIX_IS'			=> 'Пребацивач није у могућности да пронађе табеле са одабраним префиксом. Молимо проверите да ли сте унели исправне појединости за форум који пребацујете. Подразумевани префикс табеле за %1$s је <strong>%2$s</strong>.',
	...
	'INST_ERR_DB_NO_MYSQLI'		=> 'Издање MySQL инсталирано на овом рачунару је неускладљиво са избором “MySQL са MySQLi Екстензијом” који сте одабрали. Молимо вас да пробате са “MySQL” уместо тога.',
	'INST_ERR_DB_NO_SQLITE'		=> 'Издање SQLite екстензије које имате инсталирано је престаро, и мора бити надограђено најмање на издање 2.8.2.',
	'INST_ERR_DB_NO_SQLITE3'	=> 'Издање SQLite екстензије које сте инсталирали је престаро, тако да мора бити надограђено бар на издање 3.6.15.',
	'INST_ERR_DB_NO_ORACLE'		=> 'Издање Oracle инсталирано на овом рачунару захтева од вас да подесите <var>NLS_CHARACTERSET</var> параметар у <var>UTF8</var>. Или надоградите вашу инсталацију на издање 9.2+ или промените параметар.',
	...
	'PHP_SETTINGS'					=> 'PHP издање и поставке',
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Обавезно</strong> - Морате имати бар 5.3.3 издање PHP (PHP 7 није подржан) да бисте инсталирали phpBB. Ако је <var>safe mode</var> приказано испод ваша PHP инсталација ради у том моду. Ово ће проузроковати ограничења при удаљеној администрацији и сличним могућностима.',
	...
	'PHP_VERSION_REQD'				=> 'PHP издање: >= 5.3.3, < 7.0.0-dev',
	'POST_ID'						=> 'ID Поруке',
	...
	'REQUIREMENTS_EXPLAIN'		=> 'Пре почетка пуне инсталације phpBB ће извршити неке пробе на конфигурацији вашег сервера и датотекама како би осигурао да можете да инсталирате и покренете phpBB. Молимо пажљиво прочитајте исходе и немојте настављати даље док све обавезне пробе не прођу. Уколико желите да користите било коју од могућности у зависности од проби по избору, требало би да проверите да ли су и те пробе такође прошле.',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'	=> 'Ваш стари индекс претраге није пребачен. Претрага ће увек дати празан исход. Да бисте направили нови индекс претраге идите на Админ Контролну Плочу, означите Одржавање и онда изаберите Индекс претраге из подменија.',
	...
	'SUPPORT_BODY'				=> 'Пуна подршка ће бити пружена за тренутно стабилно издање phpBB3, без наплате. Ово укључује:</p><ul><li>инсталацију</li><li>конфигурацију</li><li>техничка питања</li><li>сметње повезане са могућим кваровима у овом програму</li><li>ажурирање из Release Candidate (RC) издања у најновије стабилно издање</li><li>пребацивање phpBB 2.0.x у phpBB3</li><li>пребацивање других форумских програма у phpBB3 (молимо погледајте <a href="https://www.phpbb.com/community/viewforum.php?f=486">Convertors Forum</a>)</li></ul><p>Подстичемо кориснике који још увек користе пробна односно бета издања phpBB3 да замене њихове инсталације са свежим умношком најновијег издања.</p><h2>Extensions / Styles</h2><p>За питања повезана са Прикључцима, молимо пишите у одговарајући <a href="https://www.phpbb.com/community/viewforum.php?f=451">Extensions Forum</a>.<br />За питања повезана са стиловима, предлошцима и темама, молимо пишите у одговарајући <a href="https://www.phpbb.com/community/viewforum.php?f=471">Styles Forum</a>.<br /><br />Уколико је ваше питање у вези са одређеним пакетом, молимо пишите непосредно у тему посвећену пакету.</p><h2>Obtaining Support</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">The phpBB Welcome Package</a><br /><a href="https://www.phpbb.com/support/">Support Section</a><br /><a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/">Quick Start Guide</a><br /><br />Како бисте се осигурали да увек имате најновије вести и ажурирања програма, зашто се не би <a href="https://www.phpbb.com/support/">пријавили на нашу мејлинг листу</a>?<br /><br />',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Све датотеке су ажуриране у најновије phpBB издање.',
	...
	'CHECK_FILES_UP_TO_DATE'		=> 'По вашој бази ваше издање је ажурно. Можда ћете желети да наставите са провером датотека како бисте били сигурни да су све датотеке ажурне са најновијим издањем phpBB.',
	...
	'DATABASE_UPDATE_INFO_OLD'			=> 'Датотека за ажурирање базе у install фасцикли је застарела. Молимо проверите да ли сте додали исправно издање датотеке.',
	...
	'ERROR'			=> 'Грешка',
	'EVERYTHING_UP_TO_DATE'		=> 'Све је ажурно са најновијим phpBB издањем. Сада би требало да се <a href="%1$s">пријавите на ваш форум</a> и проверите да ли све ради како треба. Не заборавите да обришете, преименујете или преместите вашу install фасциклу! Молимо пошаљите ажурне податке о вашем серверу и конфигурацијама форума преко <a href="%2$s">Пошаљи статистику</a> модула у вашој АКП.',
	...
	'FILES_NEW_CONFLICT_EXPLAIN'	=> 'Следеће датотеке су нове унутар најновијег издања али је утврђено да већ постоји датотека са истим именом унутар истог места. Ова датотека ће бити прегажена новом датотеком.',
	'FILES_NOT_MODIFIED'			=> 'Неизмењене датотеке',
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'Следеће датотеке нису измењене и представљају изворне phpBB датотеке из издања које желите да ажурирате.',
	...
	'INCOMPATIBLE_UPDATE_FILES'		=> 'Ажурне датотеке нису ускладљиве са вашим инсталираним издањем. Ваше инсталирано издање је %1$s а ажурна датотека је за ажурирање phpBB %2$s у %3$s.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Није пронађена исправна update фасцикла, молимо вас да проверите да ли сте додали одговарајуће датотеке.<br /><br />Ваша инсталација <strong>не</strong> изгледа да је ажурна. Ажурирања су доступна за ваше издање phpBB %1$s, молимо посетите <a href="https://www.phpbb.com/downloads/" rel="external">https://www.phpbb.com/downloads/</a> како бисте прибавили исправан пакет за ажурирање са Издања %2$s у Издање %3$s.',
	'NO_UPDATE_FILES_UP_TO_DATE'	=> 'Ваше издање је ажурно. Нема потребе да покрећете алат за ажурирање. Ако желите да проверите интегритет ваших датотека проверите да ли сте додали исправне датотеке за ажурирање.',
	...
	'OLD_UPDATE_FILES'		=> 'Ажурне датотеке су застареле. Пронађене датотеке су за ажурирање са phpBB %1$s у phpBB %2$s али најновије phpBB издање је %3$s.',

	'PACKAGE_UPDATES_TO'				=> 'Тренутни пакет се ажурира у издање',
	...
	'PREVIOUS_VERSION'					=> 'Претходно издање',
	'PROGRESS'							=> 'У току',
	...
	'STAGE_VERSION_CHECK'		=> 'Провера издања',
	...
	'UPDATE_VERSION_OPTIMIZE'		=> 'Надограђујем издање и оптимизујем табеле',
	'UPDATING_DATA'					=> 'Ажурирам податке',
	'UPDATING_TO_LATEST_STABLE'		=> 'Надограђујем базу у најновије стабилно издање',
	'UPDATED_VERSION'				=> 'Ажурирано издање',
	'UPGRADE_INSTRUCTIONS'			=> 'Ново издање <strong>%1$s</strong> је доступно. Молимо прочитајте <a href="%2$s" title="%2$s"><strong>Обавештење о издању</strong></a> како бисте научили шта се муди, и како да надоградите.',
