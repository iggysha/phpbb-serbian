...
/**
*
* help_bbcode [Serbian (Cyrillic script)]
*
* @package language
* @version $Id$
...
$help = array(
	...
	array(
		...
		1 => 'phpBB ББКод садржи таг за убацивање слика у ваше поруке. Две врло важне ствари које требате да запамтите приликом коришћења овог тага су: многи корисници не цене пуно слика у порукама и друго је да слика коју приказујете већ мора бити доступна на интернету (не може постојати на вашем рачунару на пример, изузев уколико није веб сервер!). Да бисте приказали слику морате окружити URL који води до слике са <strong>[img][/img]</strong> таговима. На пример:<br /><br /><strong>[img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img]</strong><br /><br />као што је забележено у URL одељку изнад можете окружити слику са <strong>[url][/url]</strong> таговима уколико желите, н.пр.<br /><br /><strong>[url=http://www.google.com/][img]</strong>http://www.google.com/intl/en_ALL/images/logo.gif<strong>[/img][/url]</strong><br /><br />ће дати:<br /><br /><a href="http://www.google.com/"><img src="http://www.google.com/intl/en_ALL/images/logo.gif" alt="" /></a>'
	),
	array(
