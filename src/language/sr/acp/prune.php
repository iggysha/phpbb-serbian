...
$lang = array_merge($lang, array(
	...
	'JOINED_EXPLAIN'			=> 'Унесите датум у <kbd>ГГГГ-ММ-ДД</kbd> облику. Можете користити оба поља да назначите временско раздобље, или оставите једно поље празно за отворен распон датума.',
