...
$lang = array_merge($lang, array(
	...
	'FORUM_DESC'						=> 'Опис',
	'FORUM_DESC_EXPLAIN'				=> 'Свака HTML ознака унесена овде биће приказана као што изгледа. Уколико је одабрани форум тип категорија опис се не користи.',
	...
	'LINK'						=> 'Веза',
	'LIMIT_SUBFORUMS'			=> 'Ограничи легенду на подфоруме који су директни потомци',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'Ограничава приказане подфоруме само на оне који су директни потомци (деца) тренутног форума. Када је ова опција искључена биће приказани сви подфоруми код којих је укључена опција “Прикажи подфорум на списку родитељског форума”, без обзира на дубину.',
