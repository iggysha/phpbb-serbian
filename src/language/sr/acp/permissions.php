...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>За више података о подешавању и управљању дозволама на вашем phpBB3 форуму, молимо погледајте одељак на <a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/permissions/">Setting permissions of our Quick Start Guide</a>.</p>
	',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Може користити све могућности форума, укључујући писање саопштења и лепљивих. Може такође занемаривати ограничење поплаве.<br />Није препоручљиво за обичне кориснике.',
	...
	'ROLE_DESCRIPTION_USER_FULL'			=> 'Може да користи све доступне могућности форума за кориснике, укључујући мењање имена корисника или занемаривање ограничења поплаве.<br />Није препоручљиво.',
	...
	'ROLE_DESCRIPTION_USER_STANDARD'		=> 'Може приступати многим али не свим могућностима. Не може мењати име корисника нити занемаривати ограничење поплаве, на пример.',
	...
	'TRACE_GROUP_NEVER_TOTAL_NEVER'	=> 'Дозвола ове групе је подешена на <strong>НИКАДА</strong> као укупан исход тако да је стари исход задржан.',
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'Дозвола ове групе за овај форум је подешена на <strong>НИКАДА</strong> као укупан исход тако да је стари исход сачуван.',
	...
	'TRACE_GROUP_YES_TOTAL_YES'		=> 'Дозвола ове групе је подешена на <strong>ДА</strong> и укупна дозвола је већ подешена на <strong>ДА</strong>, тако да је укупни исход задржан.',
	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'	=> 'Дозвола ове групе за овај форум је подешена на <strong>ДА</strong> и укупна дозвола је већ подешена на <strong>ДА</strong>, тако је је укупни исход задржан.',
	'TRACE_PERMISSION'				=> 'Праћење дозволе - %s',
	'TRACE_RESULT'					=> 'Прати исход',
	'TRACE_SETTING'					=> 'Праћење поставке',

	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> 'Дозвола корисника независно од форума сматра се <strong>ДА</strong> али укупна дозвола је већ подешена на <strong>ДА</strong>, тако да је укупан исход задржан. %sПраћење глобалне дозволе%s',
	'TRACE_USER_GLOBAL_YES_TOTAL_NEVER'		=> 'Дозвола корисника независно од форума сматра се <strong>ДА</strong> што преписује преко тренутног месног исхода <strong>НИКАДА</strong>. %sПраћење глобалне дозволе%s',
